...
| 2020-11-04 | @burkhardtr | 2h | Developed a back-of-the-hand program to generate and convert (x,y) lines to (x,y) points at a specific interval to (theta, rho) points. A more thorough write up of my process and results are available in the wiki. | #23 | msoe-sisbot |
