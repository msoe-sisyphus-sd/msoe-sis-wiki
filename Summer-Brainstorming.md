...
*   **What is a SIsyphus table / company?    @everyone**
    *   A sisyphus table is a kinetic table with sand in the middle and you can control a ball in the middle to create art designs using the ball in the middle. The company sisyphus industries provides the tables and firmware for the tables.
        *   About page for Sisyphus table: [https://sisyphus-industries.com/about/](https://sisyphus-industries.com/about/)
    *   Capable of producing some of the dopest [pictures](https://photos.google.com/share/AF1QipMpOe571zrFkWFiYJf4nUoXpgQtM1jx_4RnDCY_ZuHVRiqG-BZH6fqqkkb1G51HMA?key=S0pSNkNkTjMteTZOOUNtZElLQ2hkTFhYNlFHbnVR), like ever.
*   **What does their software look like?  **
    *   It looks like we don’t have access to the software itself but the table itself connects over WIFI and we can send requests to it or there is a smartphone app for connecting to the table.
        *   Article for connecting to the table: [https://sisyphus-industries.zendesk.com/hc/en-us/articles/360004786031-Connecting-to-your-table](https://sisyphus-industries.zendesk.com/hc/en-us/articles/360004786031-Connecting-to-your-table)
    ...
    *   It looks like you can create your own paths or get custom paths for the table. 
        *   Link to getting more paths: [https://sisyphus-industries.zendesk.com/hc/en-us/articles/360004786271-How-do-I-get-more-tracks-paths-](https://sisyphus-industries.zendesk.com/hc/en-us/articles/360004786271-How-do-I-get-more-tracks-paths-)
...
*   **What does their software actually run on?**
    *   It seems like there is some OS/Firmware running on the table and you can plug an SD card into the table
        *   Link to Firmware troubleshooting: [https://sisyphus-industries.zendesk.com/hc/en-us/articles/360035854171-Firmware-upgrade-troubleshooting](https://sisyphus-industries.zendesk.com/hc/en-us/articles/360035854171-Firmware-upgrade-troubleshooting)
        *   Link to reimaging an SD card: [https://sisyphus-industries.zendesk.com/hc/en-us/articles/360004729932-Steps-to-re-image-SD](https://sisyphus-industries.zendesk.com/hc/en-us/articles/360004729932-Steps-to-re-image-SD)
    *   From an interview conducted a few years ago (2016?) it looks like the sisyphus table is using a Raspberry pi 3. Two motors control the “Sisbot” (larger tables) or two stepper motors using[ Trinamic drivers](https://www.trinamic.com/products/drives/) for smaller ones.
    *   Popular Raspberry Pi magazine did an [issue ](https://magpi.raspberrypi.org/articles/sisyphus)on the Sisyphus project, too, listing some more of the technical details.
...
*   **Who’s in charge (ask Dr. Taylor)? @George**
    *   _Will we need to get our own table? Or should we use yours?_
    ...
    *   _Schedule a call? Maybe? Schedule permitting?_
...
*   **What does their open source community look like?**
    *   **What does the community actually do?**
        ...
        *   Users can also contribute to this [site](https://sandify.org/) which allows users to graphically design a shape and then download the code for the shape.
    *   **How big are they?**
...
<strong>Project Idea</strong>
   ...
   <td><strong>Stuart</strong>
   </td>
   <td><strong>Grace</strong>
   </td>
   <td><strong>Joe</strong>
   </td>
   <td><strong>Andy</strong>
   </td>
...
*   General Workflow: Take the picture and convert it to a .thr file or a .svg. Then the .thr or .svg can be uploaded to the table or to [https://webcenter.sisyphus-industries.com/  ](https://webcenter.sisyphus-industries.com/)
*   An open source web app like this already exists for .thr files: [https://sandify.org/](https://sandify.org/)
    *   Written in React
    *   GitHub repository: [https://github.com/jeffeb3/sandify](https://github.com/jeffeb3/sandify)
*   Another open source project which takes any image and converts it to a sisyphus track
    *   Written in Java 7
    *   GithubRepository: [https://github.com/markyland/SisyphusForTheRestOfUs](https://github.com/markyland/SisyphusForTheRestOfUs)
*   Ideas for this
...
*   The creator made a  Reddit post that outlines how to use it: ([https://www.reddit.com/r/SisyphusIndustries/comments/83ryo8/sisyphusfortherestofus_is_ready_instructions_in/](https://www.reddit.com/r/SisyphusIndustries/comments/83ryo8/sisyphusfortherestofus_is_ready_instructions_in/))
    *   Issues:
...
*   A common way to find lines from an image is to use the Hough Transform ([https://en.wikipedia.org/wiki/Hough_transform](https://en.wikipedia.org/wiki/Hough_transform)) 
*   Example program that finds lines in a picture using the Hough Transform using Matlab: [https://www.mathworks.com/help/images/hough-transform.html](https://www.mathworks.com/help/images/hough-transform.html)
...
*   Many nerd dweebs have addressed the idea of building their own kinetic sand table as well:
    *   [https://forum.v1engineering.com/t/does-this-count-as-a-build/6037/19](https://forum.v1engineering.com/t/does-this-count-as-a-build/6037/19) 
...
1. Build out an emulator which performs the same calculations as the sisyphus table but emulates behavior so users can test against the emulator before uploading to the machine
*   This would be useful to use if we are remote next year because an emulator means we can test code without a table
2. Build out an emulator which acts as a digital sisyphus table for the same zen purposes
